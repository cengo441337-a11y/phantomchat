...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -20188842;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiWalletEthApiArgosWipeMnemonicSidecar({
    required String storagePath,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<List<ArgosTxRow>> crateApiWalletArgosRecentSignatures({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_argos_tx_row,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiWalletArgosRecentSignaturesConstMeta,
        argValues: [limit],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiWalletArgosRecentSignaturesConstMeta =>
      const TaskConstMeta(
        debugName: "argos_recent_signatures",
        argNames: ["limit"],
      );
  ...
  Future<void> crateApiWalletEthApiArgosWipeMnemonicSidecar({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiWalletEthApiArgosWipeMnemonicSidecarConstMeta,
  ...
  TaskConstMeta get kCrateApiWalletEthApiArgosWipeMnemonicSidecarConstMeta =>
      const TaskConstMeta(
        debugName: "argos_wipe_mnemonic_sidecar",
  ...
  ArgosTxRow dco_decode_argos_tx_row(dynamic raw) {
    ...
    return ArgosTxRow(
      ...
      blockTime: dco_decode_i_64(arr[2]),
      failed: dco_decode_bool(arr[3]),
  ...
  List<ArgosTxRow> dco_decode_list_argos_tx_row(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_argos_tx_row).toList();
  }
  ...
  ArgosTxRow sse_decode_argos_tx_row(SseDeserializer deserializer) {
    ...
    var var_blockTime = sse_decode_i_64(deserializer);
  ...
  List<ArgosTxRow> sse_decode_list_argos_tx_row(SseDeserializer deserializer) {
    ...
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_argos_tx_row(deserializer));
    }
    return ans_;
  }
  ...
  void sse_encode_argos_tx_row(ArgosTxRow self, SseSerializer serializer) {
    ...
    sse_encode_i_64(self.blockTime, serializer);
  ...
  void sse_encode_list_argos_tx_row(
    ...
    for (final item in self) {
      sse_encode_argos_tx_row(item, serializer);
    }
  }
